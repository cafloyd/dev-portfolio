    ...
    render={(data) => {
      ...
      return (
        <ReactHelmet htmlAttributes={{ lang: 'en' }}>
          ...
          <link rel="shortcut icon" href={`https:${favicon.favicon32.src}`} />
          <meta name="theme-color" content={theme.background} />
          <meta name="image" content={`https:${favicon.favicon32.src}`} />
          <meta itemProp="name" content={title} />
          <meta itemProp="description" content={description} />
          <meta itemProp="image" content={`https:${favicon.favicon32.src}`} />
          <meta name="og:title" content={title} />
          <meta name="og:description" content={description} />
          <meta name="og:image" content={`https:${favicon.bigIcon.src}`} />
          ...
          <meta name="twitter:image" content={`https:${favicon.bigIcon.src}`} />
          <meta
